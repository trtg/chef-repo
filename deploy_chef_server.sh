...
USER="pick_a_user_name"
KEY_NAME="mykey" #the name shown under "Key Pairs" in AWS console
KEY_FILE="/home/your_user/.ssh/your_aws_key.pem" #the path to your AWS key
...
echo ''
echo ''
echo 'Now change the following lines in your .chef/knife.rb to match your values
knife[:aws_ssh_key_id] = "your_key_name"
knife[:aws_access_key_id]     = "YOUR_AWS_ACCESS_KEY"
knife[:aws_secret_access_key] = "YOUR_SECRET_KEY"
knife[:identity_file] ="/home/your_user/.ssh/your_aws_key.pem"
'
